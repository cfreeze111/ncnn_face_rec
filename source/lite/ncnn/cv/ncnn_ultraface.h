...
class NCNNUltraFace : public BasicNCNNHandler
{
public:
  explicit NCNNUltraFace(const std::string& _param_path, const std::string& _bin_path,
...
private:
  ...
  void generate_bboxes(std::vector<types::Boxf>& bbox_collection, ncnn::Extractor& extractor,
