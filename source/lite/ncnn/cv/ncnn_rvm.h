...
{
public:
  explicit NCNNRobustVideoMatting(const std::string& _param_path, const std::string& _bin_path,
                                  unsigned int _num_threads = 1, int _input_height = 480,
...
private:
  ...
  void generate_matting(ncnn::Extractor& extractor, types::MattingContent& content, int img_h,
                        int img_w);
