...
#ifndef LITE_AI_TOOLKIT_NCNN_CV_NCNN_FOCAL_ASIA_ARCFACE_H
#define LITE_AI_TOOLKIT_NCNN_CV_NCNN_FOCAL_ASIA_ARCFACE_H

#include "lite/ncnn/core/ncnn_core.h"

namespace ncnncv {
class NCNNFocalAsiaArcFace : public BasicNCNNHandler
{
public:
  explicit NCNNFocalAsiaArcFace(const std::string& _param_path, const std::string& _bin_path,
                                unsigned int _num_threads = 1)
    : BasicNCNNHandler(_param_path, _bin_path, _num_threads){};

  ~NCNNFocalAsiaArcFace() override = default;
