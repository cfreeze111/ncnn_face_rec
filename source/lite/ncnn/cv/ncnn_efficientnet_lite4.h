...
#ifndef LITE_AI_TOOLKIT_NCNN_CV_NCNN_EFFICIENTNET_LITE4_H
#define LITE_AI_TOOLKIT_NCNN_CV_NCNN_EFFICIENTNET_LITE4_H

#include "lite/ncnn/core/ncnn_core.h"

namespace ncnncv {
class NCNNEfficientNetLite4 : public BasicNCNNHandler
{
public:
  explicit NCNNEfficientNetLite4(const std::string& _param_path, const std::string& _bin_path,
                                 unsigned int _num_threads = 1);

  ~NCNNEfficientNetLite4() override = default;
...
#endif   // LITE_AI_TOOLKIT_NCNN_CV_NCNN_EFFICIENTNET_LITE4_H
