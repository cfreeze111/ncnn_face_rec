...
#ifndef LITE_AI_TOOLKIT_NCNN_CV_NCNN_IBNNET_H
#define LITE_AI_TOOLKIT_NCNN_CV_NCNN_IBNNET_H

#include "lite/ncnn/core/ncnn_core.h"

namespace ncnncv {
class NCNNIBNNet : public BasicNCNNHandler
{
public:
  explicit NCNNIBNNet(const std::string& _param_path, const std::string& _bin_path,
                      unsigned int _num_threads = 1);

  ~NCNNIBNNet() override = default;
...
#endif   // LITE_AI_TOOLKIT_NCNN_CV_NCNN_IBNNET_H
