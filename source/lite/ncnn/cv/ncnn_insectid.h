...
#ifndef LITE_AI_TOOLKIT_NCNN_CV_NCNN_INSECTID_H
#define LITE_AI_TOOLKIT_NCNN_CV_NCNN_INSECTID_H

#include "lite/ncnn/core/ncnn_core.h"

namespace ncnncv {
class NCNNInsectID : public BasicNCNNHandler
{
public:
  explicit NCNNInsectID(const std::string& _param_path, const std::string& _bin_path,
                        unsigned int _num_threads = 1);

  ~NCNNInsectID() override = default;
...
private:
  const char* class_names[2037] = {"Pseudoscorpiones",
                                   "Diplopoda",
                                   "Megymenum",
                                   "Cicadellidae",
                                   "Bothrogonia addita",
...
#endif   // LITE_AI_TOOLKIT_NCNN_CV_NCNN_INSECTID_H
