...
#ifndef LITE_AI_TOOLKIT_NCNN_CV_NCNN_RESNET_H
#define LITE_AI_TOOLKIT_NCNN_CV_NCNN_RESNET_H

#include "lite/ncnn/core/ncnn_core.h"

namespace ncnncv {
class NCNNResNet : public BasicNCNNHandler
{
public:
  explicit NCNNResNet(const std::string& _param_path, const std::string& _bin_path,
                      unsigned int _num_threads = 1);

  ~NCNNResNet() override = default;
...
#endif   // LITE_AI_TOOLKIT_NCNN_CV_NCNN_RESNET_H
