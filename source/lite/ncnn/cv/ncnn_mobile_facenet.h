...
#ifndef LITE_AI_TOOLKIT_NCNN_CV_NCNN_MOBILE_FACENET_H
#define LITE_AI_TOOLKIT_NCNN_CV_NCNN_MOBILE_FACENET_H

#include "lite/ncnn/core/ncnn_core.h"

namespace ncnncv {
class NCNNMobileFaceNet : public BasicNCNNHandler
{
public:
  explicit NCNNMobileFaceNet(const std::string& _param_path, const std::string& _bin_path,
                             unsigned int _num_threads = 1)
    : BasicNCNNHandler(_param_path, _bin_path, _num_threads){};

  ~NCNNMobileFaceNet() override = default;
