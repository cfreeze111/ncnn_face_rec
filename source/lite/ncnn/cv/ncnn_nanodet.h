...
{
public:
  explicit NCNNNanoDet(const std::string& _param_path, const std::string& _bin_path,
...
private:
  ...
  void generate_bboxes_single_stride(const NanoScaleParams& scale_params, ncnn::Mat& cls_pred,
