...
#ifndef LITE_AI_TOOLKIT_NCNN_CV_NCNN_MOBILENETV2_H
#define LITE_AI_TOOLKIT_NCNN_CV_NCNN_MOBILENETV2_H

#include "lite/ncnn/core/ncnn_core.h"

namespace ncnncv {
class NCNNMobileNetV2 : public BasicNCNNHandler
{
public:
  explicit NCNNMobileNetV2(const std::string& _param_path, const std::string& _bin_path,
                           unsigned int _num_threads = 1);

  ~NCNNMobileNetV2() override = default;
...
#endif   // LITE_AI_TOOLKIT_NCNN_CV_NCNN_MOBILENETV2_H
