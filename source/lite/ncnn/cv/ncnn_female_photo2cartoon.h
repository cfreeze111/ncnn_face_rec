...
namespace ncnncv {
class NCNNFemalePhoto2Cartoon : public BasicNCNNHandler
{
public:
  explicit NCNNFemalePhoto2Cartoon(const std::string& _param_path, const std::string& _bin_path,
                                   unsigned int _num_threads = 1, unsigned int _input_height = 256,
