...
namespace ncnncv {
class NCNNNanoDetEfficientNetLite : public BasicNCNNHandler
{
public:
  explicit NCNNNanoDetEfficientNetLite(const std::string& _param_path, const std::string& _bin_path,
...
private:
  ...
  void generate_bboxes_single_stride(const NanoLiteScaleParams& scale_params, ncnn::Mat& cls_pred,
                                     ncnn::Mat& dis_pred, unsigned int stride,
