...
#ifndef LITE_AI_TOOLKIT_NCNN_CV_NCNN_GHOSTNET_H
#define LITE_AI_TOOLKIT_NCNN_CV_NCNN_GHOSTNET_H

#include "lite/ncnn/core/ncnn_core.h"

namespace ncnncv {
class NCNNGhostNet : public BasicNCNNHandler
{
public:
  explicit NCNNGhostNet(const std::string& _param_path, const std::string& _bin_path,
                        unsigned int _num_threads = 1);

  ~NCNNGhostNet() override = default;
...
#endif   // LITE_AI_TOOLKIT_NCNN_CV_NCNN_GHOSTNET_H
