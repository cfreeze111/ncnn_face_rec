...
namespace ncnncv {
class NCNNFaceParsingBiSeNet : public BasicNCNNHandler
{
public:
  explicit NCNNFaceParsingBiSeNet(const std::string& _param_path, const std::string& _bin_path,
...
private:
  ...
  void generate_mask(ncnn::Extractor& extractor, const cv::Mat& mat,
