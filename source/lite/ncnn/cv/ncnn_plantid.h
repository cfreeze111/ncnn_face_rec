...
namespace ncnncv {
class NCNNPlantID : public BasicNCNNHandler
{
public:
  explicit NCNNPlantID(const std::string& _param_path, const std::string& _bin_path,
                       unsigned int _num_threads = 1);

  ~NCNNPlantID() override = default;
...
private:
  const char* class_names[4066] = {"Saururus chinensis",
                                   "Houttuynia cordata",
                                   "Aucuba chinensis",
