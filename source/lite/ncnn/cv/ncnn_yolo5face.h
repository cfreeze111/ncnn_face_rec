...
public:
  explicit NCNNYOLO5Face(const std::string& _param_path, const std::string& _bin_path,
...
private:
  ...
  void generate_bboxes_kps_single_stride(
    const YOLO5FaceScaleParams& scale_params, ncnn::Mat& det_pred, unsigned int stride,
