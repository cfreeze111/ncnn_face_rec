...
#ifndef LITE_AI_TOOLKIT_NCNN_CV_NCNN_DENSENET_H
#define LITE_AI_TOOLKIT_NCNN_CV_NCNN_DENSENET_H

#include "lite/ncnn/core/ncnn_core.h"

namespace ncnncv {
class NCNNDenseNet : public BasicNCNNHandler
{
public:
  explicit NCNNDenseNet(const std::string& _param_path, const std::string& _bin_path,
                        unsigned int _num_threads = 1);

  ~NCNNDenseNet() override = default;
...
#endif   // LITE_AI_TOOLKIT_NCNN_CV_NCNN_DENSENET_H
