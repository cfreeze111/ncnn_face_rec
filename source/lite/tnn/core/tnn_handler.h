...
protected:
  explicit BasicTNNHandler(const std::string& _proto_path, const std::string& _model_path,
...
public:
  ...
  static tnn::DimsVector get_input_shape(const std::shared_ptr<tnn::Instance>& _instance,
                                         std::string                           name);
  static tnn::DimsVector get_output_shape(const std::shared_ptr<tnn::Instance>& _instance,
                                          std::string                           name);
  static tnn::MatType    get_output_mat_type(const std::shared_ptr<tnn::Instance>& _instance,
                                             std::string                           name);
  static tnn::DataFormat get_output_data_format(const std::shared_ptr<tnn::Instance>& _instance,
                                                std::string                           name);
  static tnn::MatType    get_input_mat_type(const std::shared_ptr<tnn::Instance>& _instance,
                                            std::string                           name);
  static tnn::DataFormat get_input_data_format(const std::shared_ptr<tnn::Instance>& _instance,
                                               std::string                           name);
  static std::vector<std::string> get_input_names(const std::shared_ptr<tnn::Instance>& _instance);
  static std::vector<std::string> get_output_names(const std::shared_ptr<tnn::Instance>& _instance);
