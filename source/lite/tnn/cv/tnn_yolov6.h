...
#ifndef LITE_AI_TOOLKIT_TNN_CV_TNN_YOLOV6_H
#define LITE_AI_TOOLKIT_TNN_CV_TNN_YOLOV6_H

#include "lite/tnn/core/tnn_core.h"

namespace tnncv {
class TNNYOLOv6 : public BasicTNNHandler
{
public:
  explicit TNNYOLOv6(const std::string& _proto_path, const std::string& _model_path,
                     unsigned int _num_threads = 1);   //
  ~TNNYOLOv6() override = default;
...
#endif   // LITE_AI_TOOLKIT_TNN_CV_TNN_YOLOV6_H
