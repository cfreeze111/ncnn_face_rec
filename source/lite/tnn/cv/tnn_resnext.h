...
#ifndef LITE_AI_TOOLKIT_TNN_CV_TNN_RESNEXT_H
#define LITE_AI_TOOLKIT_TNN_CV_TNN_RESNEXT_H

#include "lite/tnn/core/tnn_core.h"

namespace tnncv {
class TNNResNeXt : public BasicTNNHandler
{
public:
  explicit TNNResNeXt(const std::string& _proto_path, const std::string& _model_path,
                      unsigned int _num_threads = 1);   //
  ~TNNResNeXt() override = default;
...
#endif   // LITE_AI_TOOLKIT_TNN_CV_TNN_RESNEXT_H
