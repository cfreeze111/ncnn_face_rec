...
namespace tnncv {
class TNNShuffleNetV2 : public BasicTNNHandler
{
public:
  explicit TNNShuffleNetV2(const std::string& _proto_path, const std::string& _model_path,
                           unsigned int _num_threads = 1);   //
  ~TNNShuffleNetV2() override = default;
