...
#ifndef LITE_AI_TOOLKIT_TNN_CV_TNN_MOBILENETV2_H
#define LITE_AI_TOOLKIT_TNN_CV_TNN_MOBILENETV2_H

#include "lite/tnn/core/tnn_core.h"

namespace tnncv {
class TNNMobileNetV2 : public BasicTNNHandler
{
public:
  explicit TNNMobileNetV2(const std::string& _proto_path, const std::string& _model_path,
                          unsigned int _num_threads = 1);   //
  ~TNNMobileNetV2() override = default;
...
#endif   // LITE_AI_TOOLKIT_TNN_CV_TNN_MOBILENETV2_H
