...
namespace tnncv {
class TNNFemalePhoto2Cartoon : public BasicTNNHandler
{
public:
  explicit TNNFemalePhoto2Cartoon(const std::string& _proto_path, const std::string& _model_path,
...
private:
  ...
  void generate_cartoon(std::shared_ptr<tnn::Instance>& _instance, const cv::Mat& mask_rs,
