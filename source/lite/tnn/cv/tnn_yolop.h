...
namespace tnncv {
class TNNYOLOP : public BasicTNNHandler
{
public:
  explicit TNNYOLOP(const std::string& _proto_path, const std::string& _model_path,
...
private:
  ...
  std::vector<float> bias_vals  = {
    -123.675f * 0.0171247f, -116.28f * 0.0175070f, -103.53f * 0.0174291f};
