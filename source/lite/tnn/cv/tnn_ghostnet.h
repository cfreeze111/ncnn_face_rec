...
#ifndef LITE_AI_TOOLKIT_TNN_CV_TNN_GHOSTNET_H
#define LITE_AI_TOOLKIT_TNN_CV_TNN_GHOSTNET_H

#include "lite/tnn/core/tnn_core.h"

namespace tnncv {
class TNNGhostNet : public BasicTNNHandler
{
public:
  explicit TNNGhostNet(const std::string& _proto_path, const std::string& _model_path,
                       unsigned int _num_threads = 1);   //
  ~TNNGhostNet() override = default;
...
#endif   // LITE_AI_TOOLKIT_TNN_CV_TNN_GHOSTNET_H
