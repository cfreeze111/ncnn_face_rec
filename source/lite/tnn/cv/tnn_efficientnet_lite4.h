...
#ifndef LITE_AI_TOOLKIT_TNN_CV_TNN_EFFICIENTNET_LITE4_H
#define LITE_AI_TOOLKIT_TNN_CV_TNN_EFFICIENTNET_LITE4_H

#include "lite/tnn/core/tnn_core.h"

namespace tnncv {
class TNNEfficientNetLite4 : public BasicTNNHandler
{
public:
  explicit TNNEfficientNetLite4(const std::string& _proto_path, const std::string& _model_path,
                                unsigned int _num_threads = 1);   //
  ~TNNEfficientNetLite4() override = default;

private:
  // In TNN: x*scale + bias
  std::vector<float> scale_vals = {1.f / 128.f, 1.f / 128.f, 1.f / 128.f};
  std::vector<float> bias_vals  = {-127.f / 128.f, -127.f / 128.f, -127.f / 128.f};
...
private:
  const char* class_names[1000] = {
    ...
    "carton",
    "car wheel",
    "cash machine, cash dispenser, automated teller machine, automatic teller machine, automated "
...
#endif   // LITE_AI_TOOLKIT_TNN_CV_TNN_EFFICIENTNET_LITE4_H
