...
namespace tnncv {
class TNNFSANet : public BasicTNNHandler
{
public:
  explicit TNNFSANet(const std::string& _proto_path, const std::string& _model_path,
...
private:
  void transform(const cv::Mat& mat_padded) override;   //
