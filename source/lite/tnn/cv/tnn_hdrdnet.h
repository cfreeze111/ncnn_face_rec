...
#ifndef LITE_AI_TOOLKIT_TNN_CV_TNN_HDRDNET_H
#define LITE_AI_TOOLKIT_TNN_CV_TNN_HDRDNET_H

#include "lite/tnn/core/tnn_core.h"

namespace tnncv {
class TNNHdrDNet : public BasicTNNHandler
{
public:
  explicit TNNHdrDNet(const std::string& _proto_path, const std::string& _model_path,
                      unsigned int _num_threads = 1);   //
  ~TNNHdrDNet() override = default;
...
#endif   // LITE_AI_TOOLKIT_TNN_CV_TNN_HDRDNET_H
