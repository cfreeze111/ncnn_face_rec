...
#ifndef LITE_AI_TOOLKIT_TNN_CV_TNN_MOBILE_FACENET_H
#define LITE_AI_TOOLKIT_TNN_CV_TNN_MOBILE_FACENET_H

#include "lite/tnn/core/tnn_core.h"

namespace tnncv {
class TNNMobileFaceNet : public BasicTNNHandler
{
public:
  explicit TNNMobileFaceNet(const std::string& _proto_path, const std::string& _model_path,
                            unsigned int _num_threads = 1);   //
  ~TNNMobileFaceNet() override = default;
