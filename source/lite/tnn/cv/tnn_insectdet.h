...
namespace tnncv {
class TNNInsectDet : public BasicTNNHandler
{
public:
  explicit TNNInsectDet(const std::string& _proto_path, const std::string& _model_path,
...
public:
  void detect(const cv::Mat& mat, std::vector<types::Boxf>& detected_boxes,
              float score_threshold = 0.5f, float iou_threshold = 0.45f, unsigned int topk = 100);
};
}   // namespace tnncv
