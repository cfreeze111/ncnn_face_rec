...
namespace tnncv {
class TNNNanoDet : public BasicTNNHandler
{
public:
  explicit TNNNanoDet(const std::string& _proto_path, const std::string& _model_path,
...
private:
  ...
  std::vector<float> bias_vals  = {
    -103.53f * 0.0174291f, -116.28f * 0.0175070f, -123.675f * 0.0171247f};
...
private:
  ...
  void generate_bboxes_single_stride(const NanoScaleParams&           scale_params,
                                     ...
                                     const std::shared_ptr<tnn::Mat>& dis_pred, unsigned int stride,
