...
#ifndef LITE_AI_TOOLKIT_MNN_CV_MNN_YOLOV5_V6_0_H
#define LITE_AI_TOOLKIT_MNN_CV_MNN_YOLOV5_V6_0_H

#include "lite/mnn/core/mnn_core.h"

namespace mnncv {
class MNNYoloV5_V_6_0 : public BasicMNNHandler
{
public:
  explicit MNNYoloV5_V_6_0(const std::string& _mnn_path, unsigned int _num_threads = 1);   //
  ~MNNYoloV5_V_6_0() override = default;
...
#endif   // LITE_AI_TOOLKIT_MNN_CV_MNN_YOLOV5_V6_0_H
