...
#ifndef LITE_AI_TOOLKIT_MNN_CV_MNN_MOBILENETV2_H
#define LITE_AI_TOOLKIT_MNN_CV_MNN_MOBILENETV2_H

#include "lite/mnn/core/mnn_core.h"

namespace mnncv {
class MNNMobileNetV2 : public BasicMNNHandler
{
public:
  explicit MNNMobileNetV2(const std::string& _mnn_path, unsigned int _num_threads = 1);   //
  ~MNNMobileNetV2() override = default;
...
#endif   // LITE_AI_TOOLKIT_MNN_CV_MNN_MOBILENETV2_H
