...
#ifndef LITE_AI_TOOLKIT_MNN_CV_MNN_HDRDNET_H
#define LITE_AI_TOOLKIT_MNN_CV_MNN_HDRDNET_H

#include "lite/mnn/core/mnn_core.h"

namespace mnncv {
class MNNHdrDNet : public BasicMNNHandler
{
public:
  explicit MNNHdrDNet(const std::string& _mnn_path, unsigned int _num_threads = 1);   //
  ~MNNHdrDNet() override = default;
...
#endif   // LITE_AI_TOOLKIT_MNN_CV_MNN_HDRDNET_H
