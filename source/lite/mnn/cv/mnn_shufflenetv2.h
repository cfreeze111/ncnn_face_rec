...
namespace mnncv {
class MNNShuffleNetV2 : public BasicMNNHandler
{
public:
  explicit MNNShuffleNetV2(const std::string& _mnn_path, unsigned int _num_threads = 1);   //
  ~MNNShuffleNetV2() override = default;
