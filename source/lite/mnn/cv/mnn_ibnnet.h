...
#ifndef LITE_AI_TOOLKIT_MNN_CV_MNN_IBNNET_H
#define LITE_AI_TOOLKIT_MNN_CV_MNN_IBNNET_H

#include "lite/mnn/core/mnn_core.h"

namespace mnncv {
class MNNIBNNet : public BasicMNNHandler
{
public:
  explicit MNNIBNNet(const std::string& _mnn_path, unsigned int _num_threads = 1);   //
  ~MNNIBNNet() override = default;
...
#endif   // LITE_AI_TOOLKIT_MNN_CV_MNN_IBNNET_H
