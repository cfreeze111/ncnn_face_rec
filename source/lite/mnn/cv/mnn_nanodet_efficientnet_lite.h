...
namespace mnncv {
class MNNNanoDetEfficientNetLite : public BasicMNNHandler
{
public:
  explicit MNNNanoDetEfficientNetLite(const std::string& _mnn_path,
...
private:
  ...
  void generate_bboxes_single_stride(const NanoLiteScaleParams& scale_params,
                                     ...
                                     const MNN::Tensor* device_dis_pred, unsigned int stride,
