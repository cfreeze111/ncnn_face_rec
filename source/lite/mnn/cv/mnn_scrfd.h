...
namespace mnncv {
class MNNSCRFD : public BasicMNNHandler
{
public:
...
private:
  ...
  void generate_bboxes_single_stride(const SCRFDScaleParams& scale_params, MNN::Tensor& score_pred,
                                     MNN::Tensor& bbox_pred, unsigned int stride,
