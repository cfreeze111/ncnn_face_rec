...
#ifndef LITE_AI_TOOLKIT_MNN_CV_MNN_NANODET_PLUS_H
#define LITE_AI_TOOLKIT_MNN_CV_MNN_NANODET_PLUS_H

#include "lite/mnn/core/mnn_core.h"

namespace mnncv {
class MNNNanoDetPlus : public BasicMNNHandler
{
public:
  explicit MNNNanoDetPlus(const std::string& _mnn_path, unsigned int _num_threads = 1);   //
  ~MNNNanoDetPlus() override = default;
...
#endif   // LITE_AI_TOOLKIT_MNN_CV_MNN_NANODET_PLUS_H
