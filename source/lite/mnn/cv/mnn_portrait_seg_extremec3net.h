...
#ifndef LITE_AI_TOOLKIT_MNN_CV_MNN_PORTRAIT_SEG_EXTREMEC3NET_H
#define LITE_AI_TOOLKIT_MNN_CV_MNN_PORTRAIT_SEG_EXTREMEC3NET_H

#include "lite/mnn/core/mnn_core.h"

namespace mnncv {
class MNNPortraitSegExtremeC3Net : public BasicMNNHandler
{
public:
  explicit MNNPortraitSegExtremeC3Net(const std::string& _mnn_path,
                                      unsigned int       _num_threads = 1);   //
  ~MNNPortraitSegExtremeC3Net() override = default;
...
private:
  ...
  void generate_mask(const PortraitSegExtremeC3NetScaleParams&  scale_params,
                     ...
                     types::PortraitSegContent& content, float score_threshold = 0.0f,
                     bool remove_noise = false);

public:
  void detect(const cv::Mat& mat, types::PortraitSegContent& content, float score_threshold = 0.0f,
              bool remove_noise = false);
};
}   // namespace mnncv


#endif   // LITE_AI_TOOLKIT_MNN_CV_MNN_PORTRAIT_SEG_EXTREMEC3NET_H
