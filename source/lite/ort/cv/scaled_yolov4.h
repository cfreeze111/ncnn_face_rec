...
#ifndef LITE_AI_ORT_CV_SCALED_YOLOV4_H
#define LITE_AI_ORT_CV_SCALED_YOLOV4_H

#include "lite/ort/core/ort_core.h"

namespace ortcv {
class ScaledYoloV4 : public BasicOrtHandler
{
public:
  explicit ScaledYoloV4(const std::string& _onnx_path, unsigned int _num_threads = 1)
    : BasicOrtHandler(_onnx_path, _num_threads){};

  ~ScaledYoloV4() override = default;
...
#endif   // LITE_AI_ORT_CV_SCALED_YOLOV4_H
