...
namespace ortcv {
class NanoDetEfficientNetLite : public BasicOrtHandler
{
public:
...
private:
  ...
  void generate_bboxes_single_stride(const NanoLiteScaleParams& scale_params, Ort::Value& cls_pred,
                                     Ort::Value& dis_pred, unsigned int stride,
