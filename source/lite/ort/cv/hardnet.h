...
#ifndef LITE_AI_ORT_CV_HARDNET_H
#define LITE_AI_ORT_CV_HARDNET_H

#include "lite/ort/core/ort_core.h"

namespace ortcv {
class HdrDNet : public BasicOrtHandler
{
public:
  explicit HdrDNet(const std::string& _onnx_path, unsigned int _num_threads = 1)
    : BasicOrtHandler(_onnx_path, _num_threads){};

  ~HdrDNet() override = default;
...
#endif   // LITE_AI_ORT_CV_HARDNET_H
