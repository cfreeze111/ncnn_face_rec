...
#ifndef LITE_AI_TOOLKIT_ORT_CV_YOLOV5_V6_1_H
#define LITE_AI_TOOLKIT_ORT_CV_YOLOV5_V6_1_H

#include "lite/ort/core/ort_core.h"

namespace ortcv {
class YoloV5_V_6_1 : public BasicOrtHandler
{
public:
  explicit YoloV5_V_6_1(const std::string& _onnx_path, unsigned int _num_threads = 1)
    : BasicOrtHandler(_onnx_path, _num_threads){};

  ~YoloV5_V_6_1() override = default;
...
#endif   // LITE_AI_TOOLKIT_ORT_CV_YOLOV5_V6_1_H
