...
#ifndef LITE_AI_ORT_CV_TINY_YOLOV4_COCO_H
#define LITE_AI_ORT_CV_TINY_YOLOV4_COCO_H

#include "lite/ort/core/ort_core.h"

namespace ortcv {
class TinyYoloV4COCO : public BasicOrtHandler
{
public:
  explicit TinyYoloV4COCO(const std::string& _onnx_path, unsigned int _num_threads = 1)
    : BasicOrtHandler(_onnx_path, _num_threads){};

  ~TinyYoloV4COCO() override = default;
...
#endif   // LITE_AI_ORT_CV_TINY_YOLOV4_COCO_H
