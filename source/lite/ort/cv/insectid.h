...
#ifndef LITE_AI_TOOLKIT_ORT_CV_INSECTID_H
#define LITE_AI_TOOLKIT_ORT_CV_INSECTID_H

#include "lite/ort/core/ort_core.h"

namespace ortcv {
class InsectID : public BasicOrtHandler
{
public:
  explicit InsectID(const std::string& _onnx_path, unsigned int _num_threads = 1)
    : BasicOrtHandler(_onnx_path, _num_threads){};

  ~InsectID() override = default;
...
#endif   // LITE_AI_TOOLKIT_ORT_CV_INSECTID_H
