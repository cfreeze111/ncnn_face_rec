...
#ifndef LITE_AI_ORT_CV_CENTER_LOSS_FACE_H
#define LITE_AI_ORT_CV_CENTER_LOSS_FACE_H

#include "lite/ort/core/ort_core.h"

namespace ortcv {
class CenterLossFace : public BasicOrtHandler
{
public:
...
#endif   // LITE_AI_ORT_CV_CENTER_LOSS_FACE_H
